...
conn = psycopg2.connect(database="flask_db", user="flask", 
...
def create(): 
	conn = psycopg2.connect(dbname="flask_db", 
							user="flask", 
							password="123456", 
							host="localhost", port="5432") 
...
def update(): 
	conn = psycopg2.connect(dbname="flask_db", user="flask", password="123456", host="localhost", port="5432") 
	cur = conn.cursor() 
...
def delete(): 
	conn = psycopg2.connect(dbname="flask_db", user="flask", 
	password="123456", 
	host="localhost", port="5432") 
	cur = conn.cursor() 
